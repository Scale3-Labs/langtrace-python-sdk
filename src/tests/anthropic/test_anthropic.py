...
class TestAnthropic(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.anthropic_mock, self.tracer, self.span = common_setup(
            self.data, None
        )
    ...
    def test_anthropic(self):
        ...
        # Act
        wrapped_function = messages_create(
            "anthropic.messages.create", version, self.tracer
        )
        ...
        self.assertTrue(
            self.tracer.start_as_current_span.called_once_with(
                "anthropic.messages.create", kind=SpanKind.CLIENT
            )
        )
        self.assertTrue(
        ...
        self.assertEqual(
            ...
            expected_result_data["system_fingerprint"],
        )
